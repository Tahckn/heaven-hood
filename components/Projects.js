...
function Projects({data}) {
  ...
  return (
    <div className='h-screen flex flex-col max-w-7xl px-10 justify-evenly mx-auto items-center'>
      <h1 className='text-center uppercase tracking-[20px] text-gray-500 text-1xl'>Projects</h1>
      ...
      {data.projects.map((project)=>(
        <div className='text-center mb-4 ' key={project.name}>
          ...
          <Image
          className="rounded-md object-cover  h-[210px] w-[200px] mx-auto drop-shadow-lg"
          src={project.image}
          priority={true}
          alt="pp"
          width={200}
